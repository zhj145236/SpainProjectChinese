<?php /*a:3:{s:66:"D:\wwwroot\shops.domibuy.com\app\admin\view\dashboard\welcome.html";i:1612516957;s:62:"D:\wwwroot\shops.domibuy.com\app\admin\view\public\header.html";i:1612516958;s:67:"D:\wwwroot\shops.domibuy.com\app\admin\view\public\admin_items.html";i:1612516958;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info-panel">
            ...
            <div class="mc">
                <ul>
                    ...
                    <!--
                    <li class="none">
                        <a href="<?php echo url('Chain/index',['sign'=>'verify']); ?>">
                            <div class="p_header bg-9C6CCD">
                                <i class="iconfont">&#xe676;</i>
                            </div>
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_chain')); ?></div>
        ...
        <table cellpadding="0" cellspacing="0" class="system_table">
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="http://xbyshopp.stablenewpay.com" ><?php echo htmlentities(lang('dashboard_aboutus_website')); ?></a></td>
                    <td class="gray_bg"><?php echo htmlentities(lang('dashboard_aboutus_bbs')); ?>:</td>
                    <td><a href="http://bbs.stablenewpay.com" ><?php echo htmlentities(lang('dashboard_wel_communication_bbs')); ?></a></td>
                </tr>
            </tbody>
        </table>
    </div>
