<?php /*a:3:{s:60:"D:\wwwroot\shops.domibuy.com\app\admin\view\config\base.html";i:1612516957;s:62:"D:\wwwroot\shops.domibuy.com\app\admin\view\public\header.html";i:1612516958;s:67:"D:\wwwroot\shops.domibuy.com\app\admin\view\public\admin_items.html";i:1612516958;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <form method="post" enctype="multipart/form-data" name="form1" action="">
        <div class="ncap-form-default">
            ...
            <dl>
                <dt><?php echo htmlentities(lang('site_bankname')); ?></dt>
                <dd>
                    <input id="site_bankname" name="site_bankname" value="<?php echo htmlentities($list_config['site_bankname']); ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl>
                <dt><?php echo htmlentities(lang('site_bank')); ?></dt>
                <dd>
                    <input id="site_bank" name="site_bank" value="<?php echo htmlentities($list_config['site_bank']); ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
