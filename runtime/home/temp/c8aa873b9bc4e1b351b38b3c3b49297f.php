<?php /*a:3:{s:80:"D:\wwwroot\shops.domibuy.com\app\home\view\default\seller\sellerlogin\login.html";i:1616769354;s:69:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_top.html";i:1612516962;s:72:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_footer.html";i:1612516962;}*/ ?>
<!doctype html>
<html>
    <head>
    ...
    <div class="w1200">
        ...
        <div class="w1200">
            <div class="dssc-login-container">
            	<div class="login_fanyi" onclick="location.href='https://seller.domibuy.com'">
                ...
                <form id="form_login" action="" method="post" >
                    ...
                    <div class="input codeimage clearfix">
                        ...
                        <span class="span fl">
                            ...
                            <a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='<?php echo url('Seccode/makecode'); ?>'+'?'+(new Date().getTime());;"><?php echo htmlentities(lang('wrong_checkcode_change')); ?></a>
                        </span>
                         <span class="ico"><i class="iconfont">&#xe67b;</i></span> 
                    </div>
                    <?php endif; ?>
