<?php /*a:3:{s:72:"D:\wwwroot\shops.domibuy.com\app\home\view\default\mall\login\login.html";i:1612516962;s:69:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_top.html";i:1612516962;s:72:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_footer.html";i:1612516962;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="page_login clearfix" style="background-image: url('<?php echo htmlentities(HOME_SITE_ROOT); ?>/images/login/login-bg.jpg');background-position: center center;">
    <div class="w1000">
        <div class="login_form">
            ...
            <!-- <?php if(config('ds_config.fb_isuse') =='1' || config('ds_config.tw_isuse') =='1' || config('ds_config.weixin_isuse') =='1'): ?>
            <div class="partner-login clearfix">
                <h3><?php echo htmlentities(lang('partner_account_login')); ?></h3>
                <p>
                    <?php if(config('ds_config.fb_isuse') == '1'): ?>
                    <a class="login_ico ico_fb" onclick="checkfbLoginState()" style="background: url(/public/static/home/images/login/login_ico_fb.png) no-repeat;background-size: 100% 100%;"></a>
                    <?php endif; if(config('ds_config.tw_isuse') == '1'): ?>
                    <a class="login_ico ico_tw" href="<?php echo url('Api/oa_tw'); ?>" style="background: url(/public/static/home/images/login/login_ico_tw.png) no-repeat;background-size: 100% 100%;"></a>
                    <?php endif; ?>
                </p>
            </div>
            <?php endif; ?> -->
...
<script type="text/javascript">
    ...
    function getfbUserInfo() {
        FB.api('/me', function(response) {
            ...
            //把用户token信息交给后台
            self.location= "<?php echo url('Api/fb_login'); ?>?accessToken="+fbToken;
        });
    }
    window.fbAsyncInit = function() {
        FB.init({
    　　    appId :'<?php echo htmlentities(config('ds_config.fb_appid')); ?>',
    　　    xfbml : true,
    　　    version : 'v9.0'
    　　});
    };
