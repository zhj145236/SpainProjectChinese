<?php /*a:3:{s:75:"D:\wwwroot\shops.domibuy.com\app\home\view\default\mall\login\register.html";i:1612516962;s:69:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_top.html";i:1612516962;s:72:"D:\wwwroot\shops.domibuy.com\app\home\view\default\base\mall_footer.html";i:1612516962;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="page_login clearfix" style="background-image: url('<?php echo htmlentities(HOME_SITE_ROOT); ?>/images/login/login-bg.jpg');background-position: center center;">
    <div class="w1000">
        <div class="login_form">
            <div class="mt">
                <a href="javascript:void(0)" class="on"><span><?php echo htmlentities(lang('register_account')); ?></span><i></i></a>
                <?php if(config('ds_config.sms_register') == 1): ?>
                <a href="javascript:void(0)" ><span><?php echo htmlentities(lang('register_mobile')); ?></span><i></i></a>
                <?php endif; ?>
            </div>
            <div class="mc">
                <form id="login_normal_form" method="post" action="<?php echo url('Login/register'); ?>">
                <?php if($member['member_id']): ?>
                <div class="item" style="margin:0">
                    <div class="text-area"><?php echo htmlentities(lang('recommender')); ?><input name='inviter_id' type='hidden' value='<?php echo htmlentities($member['member_id']); ?>'><span><?php echo htmlentities($member['member_name']); ?></span></div>
                </div>
                <?php endif; ?>
                <div class="form">
                    <div class="item">
                        <div class="text-area">
                            ...
                            <input type="text" id="member_name" name="member_name" class="text" placeholder="<?php echo htmlentities(lang('login_register_username_to_login')); ?>" tabindex="1"/>
                        </div>
                    </div>
                    <?php if(config('ds_config.captcha_status_register') == '1'): ?>
                     <div class="item">
                        <div class="text-area">
                            <div class="iconfont ico">&#xe67b;</div>
                ...
                <div class="form" style="display:none">
                    ...
                    <div class="item">
                        <div class="text-area">
                            ...
                            <a class="send_code valid" id="btn_sms_captcha" ds_type="1" ><?php echo htmlentities(lang('login_get_verification_code')); ?></a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                    ...
                    <div class="item">
                        <div class="text-area">
                            <div class="iconfont ico">&#xe67b;</div>
                            <input type="password" id="member_password_confirm" name="member_password_confirm" class="text" placeholder="<?php echo htmlentities(lang('login_register_ensure_password')); ?>" tabindex="2"/>
                        </div>
                    </div>
                    <div class="item">
                        <?php echo htmlentities(lang('agree_upon_registration')); ?><a href='<?php echo url("Document/index",["code"=>"agreement"]); ?>' target='_blank'><?php echo htmlentities(lang('user_registration_protocol')); ?></a>
                    </div>
                    <div class="item">
...
$(function () {
    ...
    $("#login_normal_form").validate({
        ...
        submitHandler:function(form){
            ds_ajaxpost('login_normal_form','url','<?php if(app('request')->param('ref_url')): ?><?php echo htmlentities(app('request')->param('ref_url')); else: ?><?php echo url("Member/index"); ?><?php endif; ?>');
        },
        onkeyup: false,
        rules: {
                member_name: {
                ...
                <?php endif; if(config('ds_config.captcha_status_register') == '1'): ?>
            captcha_normal: {
                required: true,
                remote: {
        ...
        messages: {
                member_name: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_input_username')); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_username_range')); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_username_range')); ?>',
                    remote: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_username_exists')); ?>'
                },
                member_password: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_input_password')); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_password_range')); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_password_range')); ?>'
                },
                member_password_confirm: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_input_password_again')); ?>',
                    equalTo: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_register_password_not_same')); ?>'
                },
                <?php if(config('ds_config.sms_register') == '1'): ?>
                sms_mobile: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_correct_phone')); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_correct_phone')); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_correct_phone')); ?>'
                },
                sms_captcha: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_sms_dynamic_code')); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo htmlentities(lang('login_sms_dynamic_code')); ?>'
                },
                <?php endif; if(config('ds_config.captcha_status_register') == '1'): ?>
            captcha_normal: {
